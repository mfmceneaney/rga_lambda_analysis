...
export RGA_LAMBDA_ANALYSIS_JOBS_SIM_MC_RGA_SSS_DIR="$RGA_LAMBDA_ANALYSIS_VOL_DIR/jobs/simulation/mc_rga_sss/dst"
export MC_RGA_SSS_DIR="$RGA_LAMBDA_ANALYSIS_VOL_DIR/jobs/c12analysis/mc_rga_sss"
...
$RGA_LAMBDA_ANALYSIS_VOL_DIR,$RGA_LAMBDA_ANALYSIS_HOME,$RGA_LAMBDA_ANALYSIS_C12_CONFIG_HOME $RGA_LAMBDA_ANALYSIS_CCFA_IMG \
...
$RGA_LAMBDA_ANALYSIS_VOL_DIR,$RGA_LAMBDA_ANALYSIS_HOME $RGA_LAMBDA_ANALYSIS_C12A_IMG"
