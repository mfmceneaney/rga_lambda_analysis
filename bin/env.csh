...
setenv RGA_LAMBDA_ANALYSIS_JOBS_SIM_MC_RGA_SSS "$RGA_LAMBDA_ANALYSIS_VOL_DIR/jobs/simulation/mc_rga_sss/dst"
setenv MC_RGA_SSS_DIR "$RGA_LAMBDA_ANALYSIS_VOL_DIR/jobs/c12analysis/mc_rga_sss"
...
alias RGA_LAMBDA_ANALYSIS_HIPO_UTILS_COMMAND 'sh -c "apptainer exec -B \$RGA_LAMBDA_ANALYSIS_VOL_DIR,\$RGA_LAMBDA_ANALYSIS_HOME,\$RGA_LAMBDA_ANALYSIS_C12_CONFIG_HOME \$RGA_LAMBDA_ANALYSIS_CCFA_IMG bash /opt/coatjava/bin/hipo-utils"'

alias RGA_LAMBDA_ANALYSIS_C12ANALYSIS_COMMAND 'sh -c "apptainer run -B \$RGA_LAMBDA_ANALYSIS_VOL_DIR,\$RGA_LAMBDA_ANALYSIS_HOME \$RGA_LAMBDA_ANALYSIS_C12A_IMG"'
